                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
                    ...
                    <div class="collapse navbar-collapse justify-content-around" id="navbarNav">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link btn btn-outline-primary rounded-pill p-3" href="proyectos.php"><i class="bi bi-file-code-fill"></i><strong> Proyectos elaborados</strong></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active btn btn-outline-primary rounded-pill p-3" href="hojaVida.php"><i class="bi bi-arrow-down-square-fill"></i> <strong>Hoja de vida</strong></a>
                            </li>
