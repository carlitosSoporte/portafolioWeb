...
<head>
    <title>Proyectos elaborados</title>
    <meta charset="utf-8">
        ...
        <div class="row">
            <div class="col">
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
                    <a class="navbar-brand" href=""> <i class="bi bi-code-slash p-3"></i><strong>Portafolio Web Carlos
                            Diaz</strong></a>
                    ...
                    <div class="collapse navbar-collapse justify-content-around" id="navbarNav">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link btn btn-outline-primary rounded-pill p-3" href="index.php"><i class="bi bi-pie-chart-fill"></i><strong> Competencias</strong></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active btn btn-outline-primary rounded-pill p-3" href="proyectos.php"><i class="bi bi-file-code-fill"></i><strong> Proyectos elaborados</strong></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link btn btn-outline-primary rounded-pill p-3" href="hojaVida.php"><i class="bi bi-arrow-down-square-fill"></i> <strong>Hoja de vida</strong></a>
                            </li>
                        ...
                        <div class="card-body">
                            <div class="row justify-content-center">
                                <div class="col-md-3 mt-5 text-warning">
                                    <p><i class="bi bi-emoji-sunglasses-fill"></i> <strong>Carlos Andres Diaz Aguirre
                                            &copy;</strong></p>
                                ...
                                <div class="col-md-3 mt-5 text-warning">
                                    <div class="row mb-3">
                                        <div class="col">
                                            <a name="" id="" class="btn btn-outline-warning rounded-circle" href="" role="button"><i class="bi bi-linkedin"></i><strong>
                                                    Linkedin</strong></a>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col">
                                            <a name="" id="" class="btn btn-outline-warning rounded-circle" href="" role="button"><i class="bi bi-facebook"></i><strong>
                                                    Facebook</strong></a>
                                        </div>
                                    </div>
                                    <div class="row">
